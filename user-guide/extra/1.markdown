...
Oh, yeah. We just went there: the lambda calculus.
...
This is standard notation for the lambda calculus, and here's how you read it:
...
lambda calculus that we have provided here:
