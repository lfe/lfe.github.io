...
If you already had ``lfetool`` installed, but it's been a while, you should
probably update it:
...
This will compile just your project code. If that's more hand-holding than you
need, you can just use ``lfetool`` directly:
...
1. Run ``lfetool tests unit`` to verify your tests. Do this for every commit.
