...
As with the ``c`` functions [c:m/1](http://blog.lfe.io/blog/tutorials/2015/08/10/0123-lfe-friday---cm1/) and [c:regs/0](http://blog.lfe.io/blog/tutorials/2015/08/15/0226-lfe-friday---cregs0/) this function exists as an LFE repl built-in command which can be called from the repl with just ``(i)``.
