...
have made prominent use of recursion when defining his axioms for deining the
...
notation and the concept of recursion in his new language (and, along with
Dijkstra, advocated for the inclusions of recursion in ALGOL).
...
#### 8.1.2.4 The Ackermann Function
